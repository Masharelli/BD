...
<div class="card-header">
    <i class="fas fa-fw fa-trophy"> </i> Torneos
</div>
...
<div class="card-header">
    <i class="fas fa-fw fa-trophy"> </i> Torneos activos
</div>
<?php
...
<div class="card-header">
    <i class="fas fa-fw fa-trophy"> </i> Torneos buscando jugadores
</div>
<?php
$conexion = oci_connect("diego", "tec2048", "localhost/xe");
...
while($row=oci_fetch_assoc($stmt)) {
    ...
    <tr>
      ...
      <td>'.$row['NOINT'].'</td>
      <td>
        <a class="btn btn-primary" href="#" role="button"> Unirte </a>
      </td>
    </tr>
    ';
}
